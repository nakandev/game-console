...
enum HwMemoryRegion {
  ...
  // HWREG_IORAM_BASEADDR        = 0x0300'0000,    HWREG_IORAM_SIZE        = 1*1024,
  HWREG_VRAM_BASEADDR         = 0x0400'0000,    HWREG_VRAM_SIZE         = 128*1024,
  // HWREG_PALRAM_BASEADDR       = 0x0500'0000,    HWREG_PALRAM_SIZE       = 4*1024,
  HWREG_TILERAM_BASEADDR      = 0x0600'0000,    HWREG_TILERAM_SIZE      = 8*1024*1024,  // fix to 1*1024*1024?
  // HWREG_TILERAM_BASEADDR      = 0x0600'0000,    HWREG_TILERAM_SIZE      = 128*1024,
...
/* -------- IO -------- */
enum {
  HWREG_IO_VIDEO_ADDR = HWREG_IORAM_BASEADDR + 0x0000'0000,
  HWREG_IO_SCREEN_W_ADDR = HWREG_IO_VIDEO_ADDR + 0x0000,
  HWREG_IO_SCREEN_H_ADDR = HWREG_IO_VIDEO_ADDR + 0x0002,
  HWREG_IO_SCANLINE_ADDR = HWREG_IO_VIDEO_ADDR + 0x0010,

  HWREG_IO_AUDIO_ADDR = HWREG_IORAM_BASEADDR + 0x0000'0100,
  HWREG_IO_MUSICFRAME_ADDR = HWREG_IO_AUDIO_ADDR + 0x0000,
  HWREG_IO_AUDIO_XXXX_ADDR = HWREG_IO_AUDIO_ADDR + 0x0004,

  HWREG_IO_INPUT_ADDR = HWREG_IORAM_BASEADDR + 0x0000'0200,
  HWREG_IO_PAD0_ADDR = HWREG_IO_INPUT_ADDR + 0x0000,
  HWREG_IO_PAD1_ADDR = HWREG_IO_INPUT_ADDR + 0x0010,
  HWREG_IO_KEYBOARD_ADDR = HWREG_IO_INPUT_ADDR + 0x0020,
  HWREG_IO_TOUCH_ADDR = HWREG_IO_INPUT_ADDR + 0x0030,

  HWREG_IO_DMA_ADDR = HWREG_IORAM_BASEADDR + 0x0000'0300,
  HWREG_IO_DMA0_ADDR = HWREG_IO_DMA_ADDR + 0x0000,
  HWREG_IO_DMA1_ADDR = HWREG_IO_DMA_ADDR + 0x0010,
  HWREG_IO_DMA2_ADDR = HWREG_IO_DMA_ADDR + 0x0020,
  HWREG_IO_DMA3_ADDR = HWREG_IO_DMA_ADDR + 0x0030,

  HWREG_IO_TIMER_ADDR = HWREG_IORAM_BASEADDR + 0x0000'0400,
  HWREG_IO_TIMER0_ADDR = HWREG_IO_TIMER_ADDR + 0x0000,
  HWREG_IO_TIMER1_ADDR = HWREG_IO_TIMER_ADDR + 0x0010,
  HWREG_IO_TIMER2_ADDR = HWREG_IO_TIMER_ADDR + 0x0020,
  HWREG_IO_TIMER3_ADDR = HWREG_IO_TIMER_ADDR + 0x0030,

  HWREG_IO_SERIAL_ADDR = HWREG_IORAM_BASEADDR + 0x0000'0500,

  HWREG_IO_INT_ADDR = HWREG_IORAM_BASEADDR + 0x0000'0600,
...
// Palette
enum {
  HW_PALETTE_COLORNUM = 256,
  HW_PALETTE_BYTESIZE = 1,
  HW_PALETTE_MODE_256 = 0,
  HW_PALETTE_MODE_16  = 1,
  HW_PALETTE_BANK_SIZE = 4,
...
union HwPalette {
  uint32_t data[HW_PALETTE_COLORNUM];
  HwColor color[HW_PALETTE_COLORNUM];
};
...
enum {
  HW_TILE_W = 8,
  HW_TILE_H = 8,
  HW_TILE_BYTESIZE = HW_TILE_W * HW_TILE_H * HW_PALETTE_BYTESIZE,  // 64
  HW_TILE_BANK_SIZE = 256,
  HWREG_TILE_BASEADDR      = HWREG_TILERAM_BASEADDR + 0x0010'0000,
  HWREG_TILE_BYTESIZE    = 0x00004000,  // HW_TILE_BYTESIZE * HW_TILE_BANK_SIZE,
  ...
  HWREG_TILE4_ADDR    = HWREG_TILE_BASEADDR + HWREG_TILE_BYTESIZE * 4,
  HWREG_TILE5_ADDR    = HWREG_TILE_BASEADDR + HWREG_TILE_BYTESIZE * 5,
  HWREG_TILE6_ADDR    = HWREG_TILE_BASEADDR + HWREG_TILE_BYTESIZE * 6,
  HWREG_TILE7_ADDR    = HWREG_TILE_BASEADDR + HWREG_TILE_BYTESIZE * 7,
};

struct HwTile {
  uint8_t data[HW_TILE_H][HW_TILE_W];  // paletteIdx
};

// Tilemap
enum {
  HW_BG_TILENUM = 64 * 64,  // 4096
...
struct HwTilemap {
  union {
    ...
    uint16_t data;
  } tileIdx[HW_BG_TILENUM];
};

// BG
enum {
  HW_VPU_CPUCYCLE_RATIO = 4,
  HW_SCREEN_W = 320,
  HW_SCREEN_H = 200,
  HW_SCREEN_HBLANK = 80,
  HW_SCREEN_VBLANK = 50,
  HW_SCREEN_XTILE = HW_SCREEN_W / HW_TILE_W,
  HW_SCREEN_YTILE = HW_SCREEN_H / HW_TILE_H,
  HW_TILEMAP_W = 512,
  HW_TILEMAP_H = 256,
  HW_TILEMAP_XTILE = HW_TILEMAP_W / HW_TILE_W,
  HW_TILEMAP_YTILE = HW_TILEMAP_H / HW_TILE_H,
  ...
  HW_BG_TILE_MODE = 0,
  HW_BG_PIXEL_MODE = 1,
  HW_BG_TILESIZE_8x8   = 0,
  HW_BG_TILESIZE_16x16 = 1,
  HW_BG_TILESIZE_32x32 = 2,
  HW_BG_TILESIZE_64x64 = 3,
};
