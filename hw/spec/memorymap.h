...
// TILERAM
struct HwTileRam {
  /*__attribute__((aligned(0x08'0000)))*/ HwSP sp[1];
  /*__attribute__((aligned(0x08'0000)))*/ HwBG bg[4];
  __attribute__((aligned(0x10'0000))) HwTilemap tilemap[4];
  __attribute__((aligned(0x10'0000))) HwTile tile[8][256];
