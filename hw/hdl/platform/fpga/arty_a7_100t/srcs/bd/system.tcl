...
# Hierarchical cell: microblaze_riscv_1_local_memory
proc create_hier_cell_microblaze_riscv_1_local_memory { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_microblaze_riscv_1_local_memory() - Empty argument(s)!"}
     return
  }
  ...
  connect_bd_intf_net -intf_net microblaze_riscv_1_dlmb [get_bd_intf_pins dlmb_v10/LMB_M] [get_bd_intf_pins DLMB]
  connect_bd_intf_net -intf_net microblaze_riscv_1_dlmb_bus [get_bd_intf_pins dlmb_v10/LMB_Sl_0] [get_bd_intf_pins dlmb_bram_if_cntlr/SLMB]
  connect_bd_intf_net -intf_net microblaze_riscv_1_dlmb_cntlr [get_bd_intf_pins dlmb_bram_if_cntlr/BRAM_PORT] [get_bd_intf_pins lmb_bram/BRAM_PORTA]
  connect_bd_intf_net -intf_net microblaze_riscv_1_ilmb [get_bd_intf_pins ilmb_v10/LMB_M] [get_bd_intf_pins ILMB]
  connect_bd_intf_net -intf_net microblaze_riscv_1_ilmb_bus [get_bd_intf_pins ilmb_v10/LMB_Sl_0] [get_bd_intf_pins ilmb_bram_if_cntlr/SLMB]
  connect_bd_intf_net -intf_net microblaze_riscv_1_ilmb_cntlr [get_bd_intf_pins ilmb_bram_if_cntlr/BRAM_PORT] [get_bd_intf_pins lmb_bram/BRAM_PORTB]
  ...
  connect_bd_net -net microblaze_riscv_1_Clk [get_bd_pins LMB_Clk] [get_bd_pins dlmb_v10/LMB_Clk] [get_bd_pins dlmb_bram_if_cntlr/LMB_Clk] [get_bd_pins ilmb_v10/LMB_Clk] [get_bd_pins ilmb_bram_if_cntlr/LMB_Clk]
...
proc create_root_design { parentCell } {
  ...
  set vram_info [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 vram_info ]
  ...
  set BRAM_PORTA_1 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:bram_rtl:1.0 BRAM_PORTA_1 ]
  set_property -dict [ list \
   CONFIG.MASTER_TYPE {BRAM_CTRL} \
   CONFIG.READ_WRITE_MODE {READ_WRITE} \
   ] $BRAM_PORTA_1

  set BRAM_PORTA_2 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:bram_rtl:1.0 BRAM_PORTA_2 ]
  set_property -dict [ list \
   CONFIG.MASTER_TYPE {BRAM_CTRL} \
   CONFIG.READ_WRITE_MODE {READ_WRITE} \
   ] $BRAM_PORTA_2

  set BRAM_PORTA_3 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:bram_rtl:1.0 BRAM_PORTA_3 ]
  set_property -dict [ list \
   CONFIG.MASTER_TYPE {BRAM_CTRL} \
   CONFIG.READ_WRITE_MODE {READ_WRITE} \
   ] $BRAM_PORTA_3
  ...
  set clk_cpu [ create_bd_port -dir O -type clk clk_cpu ]
  set clk_vga [ create_bd_port -dir O -type clk clk_vga ]
  ...
  set_property -dict [list \
    CONFIG.C_S_AXI_ACLK_FREQ_HZ {24000000} \
  ...
  # Create instance: microblaze_riscv_1_local_memory
  create_hier_cell_microblaze_riscv_1_local_memory [current_bd_instance .] microblaze_riscv_1_local_memory
  ...
  connect_bd_intf_net -intf_net axi_bram_ctrl_3_BRAM_PORTA [get_bd_intf_ports BRAM_PORTA_3] [get_bd_intf_pins axi_bram_ctrl_3/BRAM_PORTA]
  ...
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports vram_info] [get_bd_intf_pins axi_gpio_1/GPIO]
  connect_bd_intf_net -intf_net axi_uartlite_0_UART [get_bd_intf_ports usb_uart] [get_bd_intf_pins axi_uartlite_0/UART]
  connect_bd_intf_net -intf_net microblaze_riscv_1_M_AXI_DC [get_bd_intf_pins microblaze_riscv_1/M_AXI_DC] [get_bd_intf_pins ram_interconnect/S00_AXI]
  connect_bd_intf_net -intf_net microblaze_riscv_1_M_AXI_DP [get_bd_intf_pins microblaze_riscv_1/M_AXI_DP] [get_bd_intf_pins perif_interconnect/S00_AXI]
  connect_bd_intf_net -intf_net microblaze_riscv_1_M_AXI_IC [get_bd_intf_pins microblaze_riscv_1/M_AXI_IC] [get_bd_intf_pins ram_interconnect/S01_AXI]
  connect_bd_intf_net -intf_net microblaze_riscv_1_debug [get_bd_intf_pins mdm_riscv_0/MBDEBUG_0] [get_bd_intf_pins microblaze_riscv_1/DEBUG]
  connect_bd_intf_net -intf_net microblaze_riscv_1_dlmb_1 [get_bd_intf_pins microblaze_riscv_1/DLMB] [get_bd_intf_pins microblaze_riscv_1_local_memory/DLMB]
  connect_bd_intf_net -intf_net microblaze_riscv_1_ilmb_1 [get_bd_intf_pins microblaze_riscv_1/ILMB] [get_bd_intf_pins microblaze_riscv_1_local_memory/ILMB]
  connect_bd_intf_net -intf_net mig_7series_0_DDR3 [get_bd_intf_ports ddr3_sdram] [get_bd_intf_pins mig_7series_0/DDR3]
  connect_bd_intf_net -intf_net perif_interconnect_M00_AXI [get_bd_intf_pins axi_gpio_0/S_AXI] [get_bd_intf_pins perif_interconnect/M00_AXI]
  connect_bd_intf_net -intf_net perif_interconnect_M01_AXI [get_bd_intf_pins axi_uartlite_0/S_AXI] [get_bd_intf_pins perif_interconnect/M01_AXI]
  connect_bd_intf_net -intf_net perif_interconnect_M02_AXI [get_bd_intf_pins perif_interconnect/M02_AXI] [get_bd_intf_pins axi_gpio_1/S_AXI]
  connect_bd_intf_net -intf_net perif_interconnect_M03_AXI [get_bd_intf_pins perif_interconnect/M03_AXI] [get_bd_intf_pins axi_bram_ctrl_0/S_AXI]
  ...
  # Create port connections
  connect_bd_net -net CLK100MHZ_1 [get_bd_ports CLK100MHZ] [get_bd_pins util_ds_buf_0/BUFG_I]
  connect_bd_net -net ck_rst_1 [get_bd_ports ck_rst] [get_bd_pins mig_7series_0/sys_rst] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins rst_clk_wiz_0_200M/ext_reset_in]
  connect_bd_net -net clk_wiz_0_clk_ref [get_bd_pins clk_wiz_0/clk_ref] [get_bd_pins mig_7series_0/clk_ref_i]
  ...
  assign_bd_address -offset 0x06300000 -range 0x00001000 -target_address_space [get_bd_addr_spaces microblaze_riscv_1/Data] [get_bd_addr_segs axi_bram_ctrl_3/S_AXI/Mem0] -force
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_riscv_1/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x40010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_riscv_1/Data] [get_bd_addr_segs axi_gpio_1/S_AXI/Reg] -force
  assign_bd_address -offset 0x40600000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_riscv_1/Data] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x00004000 -target_address_space [get_bd_addr_spaces microblaze_riscv_1/Data] [get_bd_addr_segs microblaze_riscv_1_local_memory/dlmb_bram_if_cntlr/SLMB/Mem] -force
  assign_bd_address -offset 0x80000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces microblaze_riscv_1/Data] [get_bd_addr_segs mig_7series_0/memmap/memaddr] -force
  assign_bd_address -offset 0x00000000 -range 0x00004000 -target_address_space [get_bd_addr_spaces microblaze_riscv_1/Instruction] [get_bd_addr_segs microblaze_riscv_1_local_memory/ilmb_bram_if_cntlr/SLMB/Mem] -force
  assign_bd_address -offset 0x80000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces microblaze_riscv_1/Instruction] [get_bd_addr_segs mig_7series_0/memmap/memaddr] -force
