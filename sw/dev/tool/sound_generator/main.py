...
fft_fig = matplotlib.figure.Figure(figsize=(8, 2), dpi=80)
fft_subplot = fft_fig.add_subplot(111)
wave_fig = matplotlib.figure.Figure(figsize=(8, 2), dpi=80)
...
sigmod1_gadget = SignalModuleGadget('signal1')
sigmod2_gadget = SignalModuleGadget('signal2')
sigmod3_gadget = SignalModuleGadget('signal3')
sigmod4_gadget = SignalModuleGadget('signal4')
